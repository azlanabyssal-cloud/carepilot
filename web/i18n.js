// CarePilot UI translations - English, Hindi, Telugu.
//
...
(function (global) {
  ...
  var STRINGS = {
    ...
    en: {
      ...
      hero_body: "CarePilot turns what you share before your visit into a clear, organized summary your doctor can read in seconds — instead of asking the same questions again in a room with almost no time to spare. Type, speak, or show us a photo of a prior prescription or report — whatever's easiest for you.",
      ...
      hero_stat_source: "Sources: classical clinical-history teaching; BMJ Open, 2017 (67-country consultation-length study).",
      ...
      sidebar_title: "How CarePilot works",
    ...
    hi: {
      ...
      hero_body: "CarePilot आपकी मुलाक़ात से पहले आपकी बात को एक स्पष्ट, व्यवस्थित सारांश में बदल देता है, जिसे डॉक्टर कुछ ही सेकंड में पढ़ सकें — न कि लगभग बिना समय वाले कमरे में वही सवाल दोबारा पूछें। टाइप करें, बोलें, या पुराने पर्चे या रिपोर्ट की फोटो दिखाएं — जो भी आपके लिए आसान हो।",
      ...
      hero_stat_source: "स्रोत: पारंपरिक नैदानिक इतिहास-लेखन शिक्षण; BMJ Open, 2017 (67 देशों का परामर्श-अवधि अध्ययन)।",
      ...
      sidebar_title: "CarePilot कैसे काम करता है",
    ...
    te: {
      ...
      hero_body: "CarePilot మీ సందర్శనకు ముందే మీరు చెప్పే విషయాలను స్పష్టమైన, క్రమబద్ధమైన సారాంశంగా మారుస్తుంది, దాన్ని డాక్టర్ కొన్ని సెకన్లలో చదవగలరు — దాదాపు సమయమే లేని గదిలో అదే ప్రశ్నలు మళ్ళీ అడగకుండా. టైప్ చేయండి, మాట్లాడండి, లేదా పాత ప్రిస్క్రిప్షన్ లేదా రిపోర్ట్ ఫోటో చూపించండి — మీకు సులభమైనది ఎంచుకోండి.",
      ...
      hero_stat_source: "మూలాలు: సాంప్రదాయ క్లినికల్ హిస్టరీ బోధన; BMJ Open, 2017 (67 దేశాల సంప్రదింపు-వ్యవధి అధ్యయనం).",
      ...
      sidebar_title: "CarePilot ఎలా పనిచేస్తుంది",
